...
<form class="max-w-sm mx-auto" method="post" action="/incidencias">
    @csrf
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="latitud">latitud</label>
    ...
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="longitud">longitud</label>
    ...
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="ciudad">ciudad</label>
    ...
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="estado">estado</label>
    ...
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="direccion">direccion</label>
    ...
    <div class="mb-5">
        <label for="text"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"name="descripcion">descripcion</label>
